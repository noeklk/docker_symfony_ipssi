 ...
 */
final class Version20200703131123 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE aircraft (id INT AUTO_INCREMENT NOT NULL, manufacturer VARCHAR(50) NOT NULL, basic_type VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE flight (id INT AUTO_INCREMENT NOT NULL, departure_id INT DEFAULT NULL, arrival_id INT DEFAULT NULL, aircraft_id INT NOT NULL, number VARCHAR(6) NOT NULL, price NUMERIC(7, 2) DEFAULT NULL, INDEX IDX_C257E60E7704ED06 (departure_id), INDEX IDX_C257E60E62789708 (arrival_id), INDEX IDX_C257E60E846E2F5C (aircraft_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
